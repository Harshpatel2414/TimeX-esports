    ...
    return (
        <div className='py-2 px-5 flex items-center justify-between bg-indigo-900'>
            ...
            <div className='flex items-center gap-4'>
                ...
                <Image height={48} width={48} quality={100} className='h-12 w-12 rounded-full border-2 object-center object-cover border-indigo-500' src={currentUser?.photoURL || '/images/user.jpeg'}/>
            </div>
        </div>
    )
}
