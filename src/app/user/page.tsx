  ...
  return (
    <div className='h-screen flex flex-col items-center w-full px-5'>
      <div className='py-10 flex items-center justify-center flex-col gap-2'>
        <Image width={80} height={80} quality={100} className='w-20 h-20 border-2 border-container rounded-full object-cover object-center overflow-hidden' src="/images/pubg-character.png" alt="" />
